      ...
      <CardContent className="p-0">
        <div className="flex flex-col md:flex-row items-stretch md:items-center gap-4">
            ...
            {models.map((model) => (
              <Button
                ...
                className={cn(
                  ...
                  selectedModel === model.id && "shadow-sm bg-primary/90 hover:bg-primary/100 text-primary-foreground dark:bg-primary/80 dark:text-primary-foreground dark:hover:bg-primary/90",
          ...
          <div className="flex gap-2 mt-2 md:mt-0 md:flex-1">
            ...
            <Button onClick={handleSaveKey} className="whitespace-nowrap bg-primary dark:bg-primary/80 dark:text-primary-foreground dark:hover:bg-primary/90">Save</Button>
            {hasKey && (
